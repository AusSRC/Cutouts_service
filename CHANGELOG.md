...
### Fixed
- Added catch for NaN error when input coordinates are too far from the cube. This will display the cube/request details and prompt the user to try again.
